                ...
                <div class="block block-rounded block-transparent bg-white mb-0">
                    <ul class="nav nav-tabs nav-tabs-alt" role="tablist">
                        ...
                        <li class="nav-item">
                            <button class="nav-link" id="ma-moi-tab" data-bs-toggle="tab" data-bs-target="#ma-moi"
                                role="tab" aria-controls="ma-moi" aria-selected="false">Tham gia bằng mã mời
                            </button>
                        </li>
                        <li class="nav-item">
                            <button class="nav-link" id="them-file-excel-tab" data-bs-toggle="tab"
                                ...
                                aria-selected="false">Thêm bằng file Excel
                            </button>
                        </li>
                    ...
                    <div class="block-content tab-content">
                        <div class="tab-pane fade fade-up show active" id="them-thu-cong" role="tabpanel"
                            ...
                            <form id="addSvThuCong">
                                ...
                                <button type="button" class="btn btn-sm btn-primary btn-add-sv">Thêm sinh viên</button>
                            </div>
                            </form>
                        </div>
                    ...
                    <div class="tab-pane fade fade-up" id="them-file-excel" role="tabpanel"
                        ...
                        <form id="form-upload" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                <em>Vui lòng soạn người dùng theo đúng định dạng. <a href="./public/filemau/danhsachsv.xls">Tải về file mẫu Docx</a></em>
                            </div>
