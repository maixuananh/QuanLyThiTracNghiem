<div class="content">
    <div class="js-slider slick-dotted-inner slick-dotted-white" data-dots="true" data-autoplay="true"
        ...
        <div>
            <img class="img-fluid" src="./public/media/photos/study.jpg" alt="">
        </div>
    </div>
</div>
                    ...
                    <div class="bg-body-extra-light shadow-lg">
                        <div class="js-slider slick-dotted-inner" data-dots="true" data-arrows="false"
                            ...
                            <div class="p-5">
                                ...
                                <h3 class="fs-2 fw-light mb-2">Chào mừng các bạn</h3>
                                <p class="text-muted">
                                    vui lòng điển đầy đủ thông tin để sử dụng đầy đủ dịch vụ của chúng tôi
                                </p>
